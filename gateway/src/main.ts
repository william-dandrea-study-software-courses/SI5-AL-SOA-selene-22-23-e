...
async function bootstrap() {
  ...
  app.use('/life-support', createProxyMiddleware({
  ...
  app.use('/module-life', createProxyMiddleware({
  ...
  app.use('/needs-control', createProxyMiddleware({
  ...
  app.use('/resupply', createProxyMiddleware({
