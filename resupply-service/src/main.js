...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, swaggeruiConfig, config, document, appPort;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    swaggeruiConfig = configService.get('swaggerui');
                    ...
                    swagger_1.SwaggerModule.setup(swaggeruiConfig.path, app, document);
                    // Starts listening for shutdown hooks
                    app.enableShutdownHooks();
                    appPort = configService.get('app.port');
                    return [4 /*yield*/, app.listen(appPort, function () {
